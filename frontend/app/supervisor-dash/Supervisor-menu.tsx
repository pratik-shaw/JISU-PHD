// FILE: app/supervisor-dash/Supervisor-menu.tsx
'use client';
...
export default function SupervisorMenu({ sidebarOpen, activeTab, setActiveTabAction }: SupervisorMenuProps) {
  ...
  /**
   * Navigation items for Supervisor dashboard
  ...
  return (
    <aside className={`${
      ...
      <div className="p-6">
        <h2 className="text-lg font-semibold mb-6 text-orange-400">Supervisor Portal</h2>
